...
const Testimonials = () => {
  return (
    <section id="testimonials" className='md:h-[80vh] h-fit bg-[#FFF] px-3 flex flex-col gap-2 pb-3' >
      <p className='text-[#FE8D66] roboto font-bold ' >TESTIMONIALS</p>
      <h3 className=' text-4xl text-[#1B1A1A] font-bold roboto' >What people who have <br/> taken our tour are saying</h3>
