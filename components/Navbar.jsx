    ...
    <div className='flex flex-1 items-center justify-center' >
     <ul className='md:flex hidden items-center gap-3 ' >
       {NavLinks.map((item,idx)=>(
         <li className='  uppercase text-white font-semibold roboto ' key={idx}>{item}</li>
       ))}
     </ul>
    </div>
    <button className=' roboto hidden md:block  outline-none uppercase text-white font-semibold ' >
    Contact Us
    </button>
    </nav>
  )
